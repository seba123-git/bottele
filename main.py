...
# Configuración
TOKEN = os.environ.get("TOKEN", "8078347729:AAGME0GBMgLh4AgvdF1ChtbWxLW4sRvfS1M")
...
def main():
    ...
    # Espera infinita para que Railway no detenga el contenedor
    async def wait_forever():
        while True:
            logger.debug("Bot activo y esperando...")
